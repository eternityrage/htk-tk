"""
Facebook Reels Upload - Hilltok Lens
...
def upload_to_facebook(video_path, description, title="Hilltok Lens"):
    print("\n" + "=" * 60)
    print("FACEBOOK UPLOAD STARTING - HILLTOK LENS")
    print("=" * 60)
...
def upload_to_facebook_story(video_path):
    print("\n" + "=" * 60)
    print("FACEBOOK STORY UPLOAD STARTING - HILLTOK LENS")
    print("=" * 60)
