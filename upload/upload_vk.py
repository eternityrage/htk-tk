"""
Upload videos to VK (VKontakte) - Hilltok Lens
"""
import os
import vk_api
...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        message = description if description else "Hilltok Lens - Paris Hilton Moments!\n\n#parishilton #hollywood #celebrity #fashion"
        ...
        video = upload.video(
            ...
            name=title or 'Hilltok Lens Video',
